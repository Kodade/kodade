// Provider-neutral inference types and OpenAI-compatible HTTP transport.
// Public chat providers and KödLocal share this wire seam without sharing
// product identity, settings, tool loops, or feature gates.
